...
- **Generated**: `index.adoc`, every `skills/*.adoc`, and `agents/*.adoc` are regenerated by the
  `analyze-claude-skills-and-agents` skill (`/analyze-claude-skills-and-agents`) directly from the
...
`analyze-claude-skills-and-agents` skill handles this for generated pages automatically).
