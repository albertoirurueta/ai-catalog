...
* xref:skills/java-code-one-task.adoc[] — Step 6, once per task, via its own `general-purpose` sub-agent, to
  run the scoped tests for the affected class(es) (falling back to `mvn test -Dtest=<TestClass>` directly if this
